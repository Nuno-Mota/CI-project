...
public class Neat4SpeedDriverFILLER extends Neat4SpeedDriver implements Serializable {
    ...
    public Neat4SpeedDriverFILLER(NeuralNetwork neuralNetwork) {
        initialize();
        _neuralNetwork = neuralNetwork;
    }

    public Neat4SpeedDriverFILLER(String path){
        initialize();
